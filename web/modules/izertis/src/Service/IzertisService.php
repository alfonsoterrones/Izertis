...
namespace Drupal\izertis\Service;
 ...
 */
class IzertisService implements EventSubscriberInterface {
  ...
  /**
   * Obtenemos los tipos de contenidos que queremos descargar
   * @param string $type TID de la taxonomía tipo
  ...
  /**
   * @param array $contentArray Contenido que nos llega de la web Marvel
   * @param string $type TID de la taxonomía tipo
